...
local typeofv2sfunctions = {
    ...
    buffer = function(v)
        if Read_Buffer then
            if Read_Buffer == "readi8" then
                return buffer.readi8(v, 0)
            elseif Read_Buffer == "readu8" then
                return buffer.readu8(v, 0)
            elseif Read_Buffer == "readi16" then
                return buffer.readi16(v, 0)
            elseif Read_Buffer == "readu16" then
                return buffer.readu16(v, 0)
            elseif Read_Buffer == "readi32" then
                return buffer.readi32(v, 0)
            elseif Read_Buffer == "readu32" then
                return buffer.readu32(v, 0)
            elseif Read_Buffer == "readf32" then
                return buffer.readf32(v, 0)
            elseif Read_Buffer == "readf64" then
                return buffer.readf64(v, 0)
            end
        end
    end
}
